...
import numpy as np
from function import get_J_1, get_J_2, get_zvankin_quad
...
# display_convergence_2d('.', J, methode=quadratic_conjuguate_gradient_method__, X0=np.array([[-5], [5]]),
#                        x_space=np.linspace(-10, 10, 100),
#                        y_space=np.linspace(-10, 10, 100), eps=5e-2, niter=1000)
